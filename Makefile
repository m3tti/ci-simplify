...
assets:
	...
	wget https://cdn.jsdelivr.net/npm/bootstrap-icons@${BOOTSTRAP_ICON_VERSION}/font/bootstrap-icons.min.css -O scss/vendor/bootstrap-icons.min.css
	...
	cp -r bootstrap/bootstrap-${BOOTSTRAP_VERSION}/scss scss/vendor/bootstrap
